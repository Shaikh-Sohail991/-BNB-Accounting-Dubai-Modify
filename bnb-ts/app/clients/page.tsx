...
interface Industry { icon: string; name: string; }
interface CaseStudy { company: string; sector: string; challenge: string; result: string; icon: string; }
...
const industries: Industry[] = [
  ...
  { icon: '✈️', name: 'Aviation & Travel' },
  { icon: '🏭', name: 'Manufacturing' },
];

const caseStudies: CaseStudy[] = [
  {
    company: 'AlNoor Real Estate', sector: 'Real Estate', icon: '🏗️',
  ...
  {
    company: 'TechNexus FZCO', sector: 'Technology', icon: '💻',
  ...
  {
    company: 'GulfMed Healthcare', sector: 'Healthcare', icon: '🏥',
          ...
          <div className="testimonial-cards-grid">
            {staticTestimonials.map((t: StaticTestimonial, i: number) => (
              <div key={i} className="testimonial-static-card">
                <div className="testimonial-stars-top">★★★★★</div>
